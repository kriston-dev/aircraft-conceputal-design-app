...
while true
    switch currState
        ...
        case Aircraft_constraint_states.USER_TW_AIRCRAFT_MENU
             user_aircraft_input = user_TW_saved(1).user_input;
        ...
        case Aircraft_constraint_states.EDIT_SAVED_TW_AIRCRAFT
            ...
            user_aircraft_input = edit_TW_aircraft(user_aircraft_input);

            user_TW_saved(1).user_input = user_aircraft_input;
        ...
        case Aircraft_constraint_states.GRAPH_TW
            display_TW(TW);
            user_TW_saved = save_user_aircraft(user_TW_saved, user_aircraft_input);
            currState = Aircraft_constraint_states.MAIN_MENU;
        ...
        case Aircraft_constraint_states.GET_TS_AIRCRAFT_DATA
...
user_aircraft_input.Wing_area = ...
    user_aircraft_input.Wing_area_raw:0.1:user_aircraft_input.Wing_area_final;
...
function user_aircraft_input = edit_TW_aircraft(user_aircraft_input)
...
switch edit
    ...
    case 3
        ...
        user_aircraft_input.Wing_area_final = ...
            user_aircraft_input.Wing_area_raw .* 2;

        user_aircraft_input.Wing_area = user_aircraft_input.Wing_area_raw:...
            0.1:user_aircraft_input.Wing_area_final;
...
function user_TW_saved = save_user_aircraft(user_TW_saved, user_aircraft_input)
...
if strcmpi(user_save_option, 'yes')
    ...
    new_aircraft.user_input = user_aircraft_input;
...
switch user_choice
    ...
    case 1
        currState = Aircraft_constraint_states.CALCULATE_TW_FROM_USER_TW_DATA_CALCULATION;
