...
MAC_ref = user_ST_aircraft_input.Wing_area ./ user_aircraft_TW_input.Span;
...
%There is a standard formula for the vert and horiz volume coefficient and
%is more accurate isntead of having user choose basedo n aircraft tpye.
%however, if the user does not know what they want for the area for hteir
%vert and horiz stabilizers then it can be a problem thus giving the option
%to calculate the horiz and vert area based on the tail moment arm that was
%found through the aircraft type tail volume coeff and then the second
%option of theu ser knowing what their area is and calcualte an accurate
%coeff to find an accurate tial moment arm would be best for the user.
%Will delete after this version due to simplifying my goal and direction of
