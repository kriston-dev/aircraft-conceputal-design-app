...
if isfile("user_loads_aircraft.mat")
    ...
    user_ST_saved = struct('name', {}, 'ST_aircraft_name', {}, 'user_input', {});
...
user_ST_aircraft_input.tail_efficiency = input("The efficiency of the tail: ");
...
disp("0  - Back to last page")
disp("1  - Calculate the stability and trim")
user_choice = input("Your choice: ");
