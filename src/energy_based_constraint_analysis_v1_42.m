...
X_AC = X_leading_edge_MAC + 0.25 .* ST.MAC_ref;
...
% Landing gear
user_loads_aircraft_input.Landing_gear_mass = ...
    input("Mass of landing gear (kg): ");

user_loads_aircraft_input.X_landing_gear = input("The longitudinal location " + ...
    "of center of mass of landing gear (m): ");
...
function loads = calculate_loads(ST, ...
    user_loads_aircraft_input)
...
X_components = [ ...
    ...
    user_loads_aircraft_input.X_landing_gear, ...
...
loads.X_CG = sum(initial_masses .* X_components) ./ sum(initial_masses);
