...
user_ST_aircraft_input.X_wing_root_LE = input("The longitudinal location of wing root leading edge (m): ");
...
user_loads_aircraft_input.C_L_tail_TO = ...
    input("Horizontal tail ift coefficient during takeoff: ");
...
switch user_choice
    ...
    case 1
        user_loads_aircraft_input.mass = ...
            input("mass: ");
