...
disp("34 - Maximum elevator up deflection");
disp("35 - Elevator efficiency");
disp("36 - Wing zero-lift angle of attack");
disp("37 - Horizontal tail zero-lift angle of attack");
...
%Get output from DATCOM for ease on user:
