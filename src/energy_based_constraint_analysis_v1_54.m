...
loads.ult_load_factor = 1.5 .* user_loads_aircraft_input.loads_limit_factor;

loads.ult_load_force = 1.5 .* loads.limit_load_force;

if TW.update_load_factor > user_loads_aircraft_input.loads.limit_load_factor
...
loads.nose_gear_load_factor = loads.nose_weight_factor .* ...
...
%The load factor experienced by both the main and nose gears
loads.both_gear_load_factor = ...
